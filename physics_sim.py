...
class PhysicsSim():
    ...
    def next_timestep(self, rotor_speeds):
        ...
        # ### Tatsuo edited: this part causes the change of self.init_velocities
        # ### I thus corrected as below (To see the difference, add print(self.init_velocities) in reset() above.)
        ...
        # ### Tatsuo edited: incorrect update of the angle: 3rd term on the right hand has incorrect dimension (angle is dimless)
